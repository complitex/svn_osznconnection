...
-- (2,'Сидор', 'Сидорович', 'Сидоров', 'Новосибирск', 'ул. Терешковой', 'д. 11','', 'кв. 11', '2010-09-08',1, 'CITY_UNRESOLVED_LOCALLY'),
 (3,'Петр', 'Петрович', 'Петров', 'Харьков', 'Косиора', '154А','', '1', '2010-09-08',1, 'CITY_UNRESOLVED_LOCALLY'),
 (3,'Петр1', 'Петрович1', 'Петров1', 'Харьkов', 'Kоcиорa', '154A','', '1', '2010-09-08',1, 'CITY_UNRESOLVED_LOCALLY');
