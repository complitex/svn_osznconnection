...
public enum RequestBenefitDBF{
    ...
    CM_AREA(Double.class),	    //12    CM_AREA	    NUMERIC	    2	10	Общая площадь
    HEAT_AREA(Double.class),    //13    HEAT_ AREA	NUMERIC	    2	10	Обогреваемая площадь
    ...
    RESERV1(Double.class),	    //20    RESERV1	    NUMERIC	    2	10	Резерв
