...
public enum PaymentDBF {
    ...
    FROG(Double.class, 5, 1),         //8	FROG	    NUMERIC	    5	1	Процент льгот
    FL_PAY(Double.class, 9, 2),       //9	FL_PAY	    NUMERIC	    9	2	Общая плата
    NM_PAY(Double.class, 9, 2),       //10  NM_PAY	    NUMERIC	    9	2	Плата в пределах норм потребления
    DEBT(Double.class, 9, 2),         //11	DEBT	    NUMERIC	    9	2	Сумма долга
    ...
    NORM_F_1(Double.class, 10, 4),    //20	NORM_F_1    NUMERIC	    10	4	Общая площадь (оплата жилья)
    NORM_F_2(Double.class, 10, 4),    //21	NORM_F_2	NUMERIC	    10	4	Объемы потребления (отопление)
    NORM_F_3(Double.class, 10, 4),    //22	NORM_F_3	NUMERIC	    10	4	Объемы потребления (горячего водо.)
    NORM_F_4(Double.class, 10, 4),    //23	NORM_F_4	NUMERIC 	10	4	Объемы потребления (холодное водо.)
    NORM_F_5(Double.class, 10, 4),    //24	NORM_F_5	NUMERIC	    10	4	Объемы потребления (газоснабжение)
    NORM_F_6(Double.class, 10, 4),    //25	NORM_F_6	NUMERIC	    10	4	Объемы потребления (электроэнергия)
    NORM_F_7(Double.class, 10, 4),    //26	NORM_F_7	NUMERIC	    10	4	Объемы потребления (вывоз мусора)
    NORM_F_8(Double.class, 10, 4),    //27	NORM_F_8	NUMERIC	    10	4	Объемы потребления (водоотведение)
