...
public class FileRequest {
    ...
    private int frog;       //8	FROG	NUMERIC	1	мая	Процент льгот
    private int flPay;      //9	FL_PAY	NUMERIC	2	Сентябрь	Общая плата
    private int nmPay;      //10	NM_PAY	NUMERIC	2	сентября	Плата в пределах норм потребления
    private int debt;       //11	DEBT	NUMERIC	2	сентября	Сумма долга
    ...
    private int normF1;     //20	NORM_F_1	NUMERIC	4	октября	Общая площадь (оплата жилья)
    private int normF2;     //21	NORM_F_2	NUMERIC	апреля	10	Объемы потребления (отопление)
    private int normF3;     //22	NORM_F_3	NUMERIC	Апреля	10	Объемы потребления (горячего водо.)
    private int normF4;     //23	NORM_F_4	NUMERIC	Апреля	10	Объемы потребления (холодное водо.)
    private int normF5;     //24	NORM_F_5	NUMERIC	апреля	10	Объемы потребления (газоснабжение)
    private int normF6;     //25	NORM_F_6	NUMERIC	4	октября	Объемы потребления (электроэнергия)
    private int normF7;     //26	NORM_F_7	NUMERIC	Апреля	10	Объемы потребления (вывоз мусора)
    private int normF8;     //27	NORM_F_8	NUMERIC	4	октября	Объемы потребления (водоотведение)
    ...
    private Date code31;    //47	CODE3_1	NUMERIC	6	0	Код тарифа оплаты жилья
    private Date code32;    //48	CODE3_2	NUMERIC	6	0	Код тарифа отопления
    private Date code33;    //49	CODE3_3	NUMERIC	6	0	Код тарифа горячего водоснабжения
    private Date code34;    //50	CODE3_4	NUMERIC	6	0	Код тарифа холодного водоснабжения
    private Date code35;    //51	CODE3_5	NUMERIC	6	0	Код тарифа - газоснабжение
    private Date code36;    //52	CODE3_6	NUMERIC	6	0	Код тарифа-электроэнергии
    private Date code37;    //53	CODE3_7	NUMERIC	6	0	Код тарифа - вывоз мусора
    ...
    public void setNmPay(int nmPay) {
        this.nmPay = nmPay;
    }
    ...
    public int getNormF1() {
        return normF1;
    }

    public void setNormF1(int normF1) {
        this.normF1 = normF1;
    }

    public int getNormF2() {
        return normF2;
    }

    public void setNormF2(int normF2) {
        this.normF2 = normF2;
    }

    public int getNormF3() {
        return normF3;
    }

    public void setNormF3(int normF3) {
        this.normF3 = normF3;
    }

    public int getNormF4() {
        return normF4;
    }

    public void setNormF4(int normF4) {
        this.normF4 = normF4;
    }

    public int getNormF5() {
        return normF5;
    }

    public void setNormF5(int normF5) {
        this.normF5 = normF5;
    }

    public int getNormF6() {
        return normF6;
    }

    public void setNormF6(int normF6) {
        this.normF6 = normF6;
    }

    public int getNormF7() {
        return normF7;
    }

    public void setNormF7(int normF7) {
        this.normF7 = normF7;
    }

    public int getNormF8() {
        return normF8;
    }

    public void setNormF8(int normF8) {
        this.normF8 = normF8;
    }
    ...
    public Date getCode31() {
        return code31;
    }

    public void setCode31(Date code31) {
        this.code31 = code31;
    }

    public Date getCode32() {
        return code32;
    }

    public void setCode32(Date code32) {
        this.code32 = code32;
    }

    public Date getCode33() {
        return code33;
    }

    public void setCode33(Date code33) {
        this.code33 = code33;
    }

    public Date getCode34() {
        return code34;
    }

    public void setCode34(Date code34) {
        this.code34 = code34;
    }

    public Date getCode35() {
        return code35;
    }

    public void setCode35(Date code35) {
        this.code35 = code35;
    }

    public Date getCode36() {
        return code36;
    }

    public void setCode36(Date code36) {
        this.code36 = code36;
    }

    public Date getCode37() {
        return code37;
    }

    public void setCode37(Date code37) {
        this.code37 = code37;
    }
