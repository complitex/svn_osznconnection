...
public class PuAccountNumberInfoParserTest {
    ...
    public void matchTest() {
        ...
        assertEquals(PuAccountNumberInfoParser.matches("www01234", "матвеев", "1234", "МАТвеев А.В."), true);
        ...
        assertEquals(PuAccountNumberInfoParser.matches("0001234", "Матвеев", "1234", "МАТВЕЕВ"), true);
    }
}
