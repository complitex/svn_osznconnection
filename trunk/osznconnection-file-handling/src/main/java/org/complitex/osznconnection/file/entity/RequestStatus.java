...
public enum RequestStatus implements IEnumCode {
    ...
    private static final Set<RequestStatus> ADDRESS_UNRESOLVED_STATUSES = Sets.immutableEnumSet(ImmutableList.of(ADDRESS_CORRECTED,
            CITY_UNRESOLVED_LOCALLY, STREET_UNRESOLVED_LOCALLY, STREET_AND_BUILDING_UNRESOLVED_LOCALLY, STREET_TYPE_UNRESOLVED_LOCALLY,
    ...
    private static final Set<RequestStatus> ADDRESS_UNRESOLVED_LOCALLY_STATUSES = Sets.immutableEnumSet(ImmutableList.of(ADDRESS_CORRECTED,
            ...
            STREET_TYPE_UNRESOLVED_LOCALLY, BUILDING_UNRESOLVED_LOCALLY, MORE_ONE_LOCAL_CITY, MORE_ONE_LOCAL_STREET, MORE_ONE_LOCAL_STREET_TYPE, MORE_ONE_LOCAL_BUILDING, MORE_ONE_LOCAL_BUILDING_CORRECTION,
