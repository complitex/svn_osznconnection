...
public enum FileHandlingConfig implements IConfig{
    ...
    PAYMENT_FILENAME_PREFIX("A_"),
    BENEFIT_FILENAME_PREFIX("AF"),
    PAYMENT_BENEFIT_FILENAME_SUFFIX("\\d{4}{MM}\\.DBF"),
    ACTUAL_PAYMENT_FILENAME_MASK(".*{MM}{YY}\\.DFB"),
    TARIF_PAYMENT_FILENAME_MASK("TARIF12\\.DBF"),
