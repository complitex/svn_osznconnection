...
(3,null,1,'TARIF12.dbf', 'AB', 1, -1, 2010, CURRENT_TIMESTAMP, 'TARIF', 3),
...
(7,null,1,'12345678.a01','',1,2,2012,'2012-01-01','DWELLING_CHARACTERISTICS',4),
(8,null,1,'12345678.b01','',1,2,2012,'2012-01-01','FACILITY_SERVICE_TYPE',4);
...
insert into `dwelling_characteristics`(`IDCODE`, `FIO`, `first_name`, `middle_name`, `last_name`, `date`, `city`, `CDUL`, `HOUSE`, `BLILD`, `APT`, `request_file_id`)
values
...
insert into `facility_service_type`(`IDCODE`, `FIO`, `first_name`, `middle_name`, `last_name`, `date`, `city`, `CDUL`, `HOUSE`, `BLILD`, `APT`, `request_file_id`)
values
