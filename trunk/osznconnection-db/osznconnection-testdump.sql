...
(1,2,900,5,900), (1,2,901,6,901), (1,2,905,3,905), (1,2,912,1,912);

-- User organizations
insert into organization(object_id) values (3), (4);
insert into organization_string_culture(id, locale_id, value) values (7, 1, UPPER('КП "ЖИЛКОМСЕРВИС"')),(8, 1, UPPER('12345')),
(9,1,UPPER('ЛЕНИНСКИЙ ФИЛИАЛ КП "ЖИЛКОМСЕРВИС"')),(10, 1, UPPER('123456'));
insert into organization_attribute(attribute_id, object_id, attribute_type_id, value_id, value_type_id) values
(1,3,900,7,900), (1,3,901,8,901), (1,3,905,1,905), (1,3,911,2,911),
(1,4,900,9,900), (1,4,901,10,901), (1,4,903,3,903), (1,4,905,1,905), (1,4,911,2,911);
...
--(13, 5,'Матвей', 'Матвеевич', 'Матвеев', 'Харьков', 'ФРАНТИШЕКА КРАЛА', '25А','', '19', '2010-09-09',1);
