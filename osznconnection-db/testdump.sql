...
--(3, 3, 0, 'Петр0','Петрович0','Петров0',2, '11111111', null),
 (4, 4, 1, 'Петр','Петрович','Петров',2, '2142426430', null);
...
values
 (6, 1,'Иван', 'Иванович', 'Иванов', 'Новосибирск', 'Терешковой', '18','', 'кв. 10', '2010-09-08',1),
...
--(11, 4,'Матвей2', 'Матвеевич2', 'Матвеев2', 'Харьков', 'ФРАНТИШЕКА КРАЛА', '25А','', '40', '2010-09-09',1),
