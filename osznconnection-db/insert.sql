...
(200,'Неизвестный населенный пункт'), (201,'Неизвестная улица'), (202,'Неизвестный номер дома'),
...
(300, 'Тариф не найден'), (301, 'Объект формы собственности не найден в таблице коррекций для МН'),
(302, 'Код формы собственности не найден в таблице коррекций для ОСЗН'), (303, 'Нечисловой код формы собственности в коррекции для ОСЗН'),
(304, 'Объект льготы не найден в таблице коррекций для МН'), (305, 'Код льготы не найден в таблице коррекций для ОСЗН'),
(306, 'Нечисловой код льготы в коррекции для ОСЗН'), (307, 'Нечисловой порядок льготы');
