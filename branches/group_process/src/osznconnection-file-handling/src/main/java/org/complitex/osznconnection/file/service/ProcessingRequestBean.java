...
/**
 * Класс для обработки пары payment-benefit файлов.
 * @author Artem
 */
...
public class ProcessingRequestBean extends AbstractBean {
    ...
    private void process(Payment payment, ICalculationCenterAdapter adapter, long calculationCenterId) {
        ...
        if(payment.getField(PaymentDBF.DAT1) == null || (payment.getAccountNumber() != null && !payment.getAccountNumber().isEmpty())){
            return ;
        }
