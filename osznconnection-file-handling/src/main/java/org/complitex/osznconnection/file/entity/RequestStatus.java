...
public enum RequestStatus implements IEnumCode {
    ...
    private static final Set<RequestStatus> ADDRESS_UNRESOLVED_STATUSES = Sets.immutableEnumSet(ImmutableList.of(ADDRESS_CORRECTED,
            CITY_UNRESOLVED_LOCALLY, STREET_UNRESOLVED_LOCALLY, STREET_TYPE_UNRESOLVED_LOCALLY, BUILDING_UNRESOLVED_LOCALLY,
            MORE_ONE_LOCAL_CITY, MORE_ONE_LOCAL_STREET, MORE_ONE_LOCAL_STREET_TYPE, MORE_ONE_LOCAL_BUILDING,
            MORE_ONE_LOCAL_CITY_CORRECTION, MORE_ONE_LOCAL_STREET_CORRECTION, MORE_ONE_LOCAL_STREET_TYPE_CORRECTION, MORE_ONE_LOCAL_BUILDING_CORRECTION,
            ...
            MORE_ONE_REMOTE_DISTRICT_CORRECTION, MORE_ONE_REMOTE_STREET_CORRECTION,
    ...
    private static final Set<RequestStatus> ADDRESS_UNRESOLVED_LOCALLY_STATUSES = Sets.immutableEnumSet(ImmutableList.of(ADDRESS_CORRECTED,
            CITY_UNRESOLVED_LOCALLY, STREET_UNRESOLVED_LOCALLY, STREET_TYPE_UNRESOLVED_LOCALLY, BUILDING_UNRESOLVED_LOCALLY,
            MORE_ONE_LOCAL_CITY, MORE_ONE_LOCAL_STREET, MORE_ONE_LOCAL_STREET_TYPE, MORE_ONE_LOCAL_BUILDING, MORE_ONE_LOCAL_BUILDING_CORRECTION,
    ...
    private static final Set<RequestStatus> UNBOUND_STATUSES = Sets.immutableEnumSet(ImmutableList.of(ACCOUNT_NUMBER_NOT_FOUND,
            ...
            STREET_TYPE_UNRESOLVED, STREET_UNRESOLVED, STREET_TYPE_NOT_FOUND, MORE_ONE_LOCAL_STREET,
            MORE_ONE_LOCAL_STREET_TYPE, STREET_NOT_FOUND, STREET_UNRESOLVED_LOCALLY, STREET_TYPE_UNRESOLVED_LOCALLY, MORE_ONE_LOCAL_STREET_CORRECTION,
